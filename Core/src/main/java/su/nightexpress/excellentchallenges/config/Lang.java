...
public class Lang extends EngineLang {
    ...
    public static final LangKey COMMAND_RESET_DONE  = new LangKey("Command.Reset.Done", "Reset " + GREEN + GENERIC_TYPE + GRAY +" challenges for " + GREEN + PLAYER_NAME + GRAY + "!");
    ...
    public static final LangKey COMMAND_REROLL_TOKENS_GIVE_DONE = LangKey.of("Command.RerollTokens.Give.Done", "Given " + GREEN + "x" + GENERIC_AMOUNT + " Reroll Tokens " + GRAY + "to " + GREEN + PLAYER_NAME + GRAY + "!");
    ...
    public static final LangKey COMMAND_REROLL_TOKENS_TAKE_DONE = LangKey.of("Command.RerollTokens.Take.Done", "Taken " + GREEN + "x" + GENERIC_AMOUNT + " Reroll Tokens " + GRAY + "off " + GREEN + PLAYER_NAME + GRAY + "!");
    ...
    public static final LangKey COMMAND_REROLL_TOKENS_SET_DONE = LangKey.of("Command.RerollTokens.Set.Done", "Set " + GREEN + "x" + GENERIC_AMOUNT + " Reroll Tokens " + GRAY + "for " + GREEN + PLAYER_NAME + GRAY + "!");
    ...
    public static final LangKey CHALLENGE_NOTIFY_PROGRESS  = new LangKey("Challenge.Notify.Progress", "<! type:\"action_bar\" !> " + GRAY + CHALLENGE_NAME + ": " + YELLOW + OBJECTIVE_NAME + " " + YELLOW + OBJECTIVE_PROGRESS_CURRENT + GRAY + "/" + YELLOW + OBJECTIVE_PROGRESS_MAX);
    public static final LangKey CHALLENGE_NOTIFY_COMPLETED = new LangKey("Challenge.Notify.Completed", "<! type:\"action_bar\" !> " + GRAY + CHALLENGE_NAME + ": " + GREEN + "&lCOMPLETED!");
}
