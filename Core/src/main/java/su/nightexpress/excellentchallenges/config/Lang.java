...
public class Lang extends EngineLang {
    ...
    public static final LangKey COMMAND_RESET_DONE  = new LangKey("Command.Reset.Done", "Reset " + GREEN + Placeholders.GENERIC_TYPE + GRAY +" challenges for " + GREEN + Placeholders.PLAYER_NAME + GRAY + "!");
    ...
    public static final LangKey COMMAND_REROLL_TOKENS_GIVE_DONE = LangKey.of("Command.RerollTokens.Give.Done", "Given " + GREEN + "x" + Placeholders.GENERIC_AMOUNT + " Reroll Tokens " + GRAY + "to " + GREEN + Placeholders.PLAYER_NAME + GRAY + "!");
    ...
    public static final LangKey COMMAND_REROLL_TOKENS_TAKE_DONE = LangKey.of("Command.RerollTokens.Take.Done", "Taken " + GREEN + "x" + Placeholders.GENERIC_AMOUNT + " Reroll Tokens " + GRAY + "off " + GREEN + Placeholders.PLAYER_NAME + GRAY + "!");
    ...
    public static final LangKey COMMAND_REROLL_TOKENS_SET_DONE = LangKey.of("Command.RerollTokens.Set.Done", "Set " + GREEN + "x" + Placeholders.GENERIC_AMOUNT + " Reroll Tokens " + GRAY + "for " + GREEN + Placeholders.PLAYER_NAME + GRAY + "!");
