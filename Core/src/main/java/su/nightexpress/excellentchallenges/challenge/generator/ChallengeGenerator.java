...
public class ChallengeGenerator extends AbstractConfigHolder<ExcellentChallenges> {
    ...
    private boolean objectivesUseGlobalName;
    private String objectivesGlobalName;
    ...
    public boolean load() {
        ...
        this.objectivesUseGlobalName = JOption.create("Objectives.Global_Name.Enabled", false,
            "Sets whether or not challenge generated by this config will display global objective name",
            "rather than list them all.").read(cfg);

        this.objectivesGlobalName = JOption.create("Objectives.Global_Name.Value", "???",
            "Sets the global name for all objectives for generated challenges to display.").read(cfg);
    ...
    public boolean isObjectivesUseGlobalName() {
        return objectivesUseGlobalName;
    }

    @NotNull
    public String getObjectivesGlobalName() {
        return objectivesGlobalName;
    }
